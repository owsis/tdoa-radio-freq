...
% tx_cari_lat = -7.3250054 ; % cari el-victor
% tx_cari_long = 112.7380274  ;
tx_cari_lat = -7.3200864; % cari Gen FM
tx_cari_long = 112.7312756;


% IQ Data Files
%file_identifier = 'test.dat';
file_identifier = '1000_1031_2024_5_18_11_32.dat';
...
signal_bandwidth_khz = 12;  % 400, 200, 40, 12, 0(no)
%smoothing_factor = 0;
smoothing_factor = 12;
...
heatmap_threshold = 0.90;  % heatmap point with lower mag are suppressed for html output