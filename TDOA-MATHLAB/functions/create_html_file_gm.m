function [ output_args ] = create_html_file_gm( filename, rx_lat, rx_long, hyperbola_lat, hyperbola_long, heatmap_cell, heatmap_threshold, mae_data )
...
%   mae_data:       (optional) struct with MAE and Std Dev values
